...
<p>What is the impact of a state governor’s political party on statewide COVID-19 results, as determined by regressing state incident rate as well as state death rate on governor political party after attempting to control for a variety of potentially informative governor-related features (such as sex, age, and time in office) and state-level features (such as testing rate, population density, median household income, and gdp)?</p>
